...
// CONCATENATED MODULE: ./components/Wrapper/index.js
            ...
            var components_Wrapper = (Wrapper_Wrapper);
// CONCATENATED MODULE: ./components/index.js
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReactFullpageShell =/*#__PURE__*/function (_React$Component) {
                ...
                function ReactFullpageShell(props) {
                    ...
                    _this.state = {};
                    _this.log = Object(_Logger__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_this.props.debug, 'ReactFullpageShell');
                ...
                _createClass(ReactFullpageShell, [{
                    key: "render", value: function render() {
                        return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {id: _selectors__WEBPACK_IMPORTED_MODULE_4__[/* MAIN_SELECTOR */ "d"]}, this.props.render(this));
                    }
                }]);
                return ReactFullpageShell;
            }(react__WEBPACK_IMPORTED_MODULE_2___default.a.Component);/* harmony default export */
        ...
        /***/ (function (module, exports) {
            ...
            window.fp_easings = {
                def: "easeOutQuad", linear: function (n, t, e, u) {
                    return e * n / u + t
                ...
                t.prototype = {
                    version: "5.2.0", _init: function () {
                        ...
                        if (this.enabled && m.eventType[t.type] === this.initiated) {
                            ...
                            var i, s, e, o, n = t.touches ? t.touches[0] : t, r = n.pageX - this.pointX,
                                h = n.pageY - this.pointY, a = m.getTime();
                        ...
                        var t, i = this.options.interactiveScrollbars, s = "string" != typeof this.options.scrollbars,
                            e = [], o = this;
                ...
                */
                function (l, c) {
                    l.fp_scrolloverflow = function () {
                        ...
                        var s = "fp-scrollable", n = "." + s, t = ".active", d = ".fp-section", e = d + t,
                        ...
                        var f = null, h = null, a = {
                            ...
                            setIscroll: function (t, i) {
                                if (a.hasBeenInit) {
                                    var s = fp_utils.closest(t, n) || f(n, t)[0], e = i ? "enable" : "disable";
 ...
 */
            !function (e, t, n, o, r) {
                ...
                "use strict";
                var an = "fullpage-wrapper", sn = "." + an, cn = "fp-responsive", un = "fp-notransition",
                    fn = "fp-destroyed", dn = "fp-enabled", vn = "fp-viewing", pn = "active", hn = "." + pn,
                    gn = "fp-completely", mn = "fp-section", Sn = "." + mn, bn = Sn + hn, wn = "fp-tableCell",
                    yn = "." + wn, En = "fp-auto-height", xn = "fp-normal-scroll", An = "fp-nav", Ln = "#" + An,
                    Mn = "fp-tooltip", Tn = "fp-slide", On = "." + Tn, kn = On + hn, Cn = "fp-slides", Hn = "." + Cn,
                    Rn = "fp-slidesContainer", In = "." + Rn, zn = "fp-table", Bn = "fp-slidesNav", Nn = "." + Bn,
                    jn = Nn + " a", e = "fp-controlArrow", Pn = "." + e, Wn = "fp-prev", Dn = Pn + ".fp-prev",
                    Yn = Pn + ".fp-next";
                ...
                return rn.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
                    ...
                    var n = g && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(g.licenseKey) || -1 < ln.domain.indexOf("alvarotrigo.com"),
                        r = Zn("html, body"), s = Zn("html")[0], m = Zn("body")[0];
                    if (!Gn(s, dn)) {
                        var S = {};
                        g = Xn({
                            menu: !1,
                        ...
                        var b, l, c, o, a = !1,
                            ...
                            w = "string" == typeof e ? Zn(e)[0] : e, y = Fn(), f = Un(), E = !1, t = !0, x = !0, d = [],
                            v = {m: {up: !0, down: !0, left: !0, right: !0}};
                        v.k = Xn({}, v.m);
                        var p, h, A, L, M, T, O, k, C, H, R = Dt(), I = {
                                touchmove: "ontouchmove" in rn ? "touchmove" : R.move,
                                touchstart: "ontouchstart" in rn ? "touchstart" : R.down
                            }, z = !1, B = !Gn(m, nt("OHNsd3AtZnVsbHBhZ2UtanM5T20=")),
                        ...
                        $t(), rn.fp_easings = Xn(rn.fp_easings, {
                            ...
                            if (!g.anchors.length) {
                                var e = "[data-anchor]", t = Zn(g.sectionSelector.split(",").join(e + ",") + e, w);
                                t.length && (V = !0, t.forEach(function (e) {
                                    g.anchors.push(e.getAttribute("data-anchor").toString())
                                }))
                            }
                            if (!g.navigationTooltips.length) {
                                var n = "[data-tooltip]", o = Zn(g.sectionSelector.split(",").join(n + ",") + n, w);
                            ...
                            for (var e = Zn(Sn), t = 0; t < e.length; t++) {
                                var n = t, o = e[t], r = Zn(On, o), i = r.length;
                        ...
                        var G, F, U, Q = !1, _ = 0, J = 0, K = 0, $ = 0, q = (new Date).getTime(), ee = 0, te = 0,
                            ne = y;
                        return S
                    }
                    ...
                    function se(t, e) {
                        void 0 !== e ? (e = e.replace(/ /g, "").split(",")).forEach(function (e) {
                            Gt(t, e, "m")
                        }) : Gt(t, "all", "m"), So(w, "setAllowScrolling", {value: t, directions: e})
                    }
                    ...
                    function me(e) {
                        if (!Gn(w, fn)) {
                            ...
                            for (var t = Zn(Sn), n = 0; n < t.length; ++n) {
                                var o = t[n], r = Zn(Hn, o)[0], i = Zn(On, o);
                    ...
                    function we(e) {
                        ...
                        t && uo(t, Ln + " a") ? function (e) {
                            ...
                            go(e);
                            var t = Zn(Hn, uo(this, Sn))[0], n = Zn(On, t)[eo(uo(this, "li"))];
                            St(t, n)
                    ...
                    function Ee(e) {
                        var t = e.type, o = !1, r = g.scrollOverflow,
                    ...
                    function Te(e, t) {
                        t || null != Zn(bn)[0] || ro(e, pn), o = Zn(bn)[0], Qn(e, {height: Me(e) + "px"}), g.paddingTop && Qn(e, {"padding-top": g.paddingTop}), g.paddingBottom && Qn(e, {"padding-bottom": g.paddingBottom}), void 0 !== g.sectionsColor[t] && Qn(e, {"background-color": g.sectionsColor[t]}), void 0 !== g.anchors[t] && e.setAttribute("data-anchor", g.anchors[t])
                    }
                    ...
                    function Ce() {
                        ...
                        if (So(w, "onScroll"), (!g.autoScrolling || g.scrollBar || Ut("dragAndMove")) && !Jt()) {
                            var t = Ut("dragAndMove") ? Math.abs(S.dragAndMove.getCurrentScroll()) : po(), n = 0,
                                o = t + Fn() / 2,
                            ...
                            if (!Gn(e = i[n], pn)) {
                                Q = !0;
                                var a, s, c = Zn(bn)[0], u = eo(c, Sn) + 1, f = Ot(e),
                                    d = e.getAttribute("data-anchor"), v = eo(e, Sn) + 1, p = Zn(kn, e)[0], h = {
                                        activeSection: c,
                                        sectionIndex: v - 1,
                                        anchorLink: d,
                                        element: e,
                    ...
                    function Pe(e) {
                        var t = (new Date).getTime(), n = Gn(Zn(".fp-completely")[0], xn);
                        if (!v.m.down && !v.m.up) return go(e), !1;
                        if (g.autoScrolling && !c && !n) {
                            var o = (e = e || rn.event).wheelDelta || -e.deltaY || -e.detail,
                                r = Math.max(-1, Math.min(1, o)), i = void 0 !== e.wheelDeltaX || void 0 !== e.deltaX,
                    ...
                    function We(e, t) {
                        var n = null == t ? Zn(bn)[0] : t, o = Zn(Hn, n)[0];
                        if (!(null == o || _t() || a || Zn(On, o).length < 2)) {
                            var r = Zn(kn, o)[0], i = null;
                    ...
                    function Ye(e) {
                        var t = e.offsetHeight, n = e.offsetTop, o = n,
                            ...
                            i = o - y + t, l = g.bigSectionsDestination;
                    ...
                    function ot(f) {
                        var d = void 0 !== X[f] && X[f].length, e = [], v = !1;
                        return oo(X[f]) ? e = X[f] : e.push(X[f]), e.forEach(function (e) {
                            var t = function () {
                                ...
                                o = nt(n[0]), r = nt(n[1]), i = nt(n[2]), l = nt(n[3]),
                    ...
                    function st() {
                        var e = ut(), t = e.section, n = e.slide;
                        t && (g.animateAnchor ? zt(t, n) : ve(t, n))
                    }

                    function ct() {
                        if (!Q && !g.lockAnchors) {
                            var e = ut(), t = e.section, n = e.slide, o = void 0 === b,
                    ...
                    function ft(e) {
                        clearTimeout(k);
                        var t = ln.activeElement, n = e.keyCode;
                        9 === n ? function (e) {
                            var t, n, o, r, i, l, a, s = e.shiftKey, c = ln.activeElement, u = ht(tt(Zn(bn)[0]));
                            ...
                            !function (e) {
                                var t = e.shiftKey, n = ln.activeElement, o = bo(n, "video") || bo(n, "audio");
                    ...
                    function At() {
                        var e = g.responsive || g.responsiveWidth, t = g.responsiveHeight, n = e && rn.innerWidth < e,
                    ...
                    function Pt(e) {
                        if (!e) return null;
                        var t = e.getAttribute("data-anchor"), n = eo(e);
                        return null == t && (t = n), t
                    }

                    function Wt() {
                        var e = Zn(bn)[0], t = Zn(kn, e)[0], n = Pt(e), o = Pt(t), r = String(n);
                    ...
                    function Dt() {
                        return rn.PointerEvent ? {down: "pointerdown", move: "pointermove"} : {
                            down: "MSPointerDown",
                            move: "MSPointerMove"
                        }
                    }
                    ...
                    function Zt(e) {
                        var t = Math.round(e);
                        if (g.css3 && g.autoScrolling && !g.scrollBar) Rt("translate3d(0px, -" + t + "px, 0px)", !1); else if (g.autoScrolling && !g.scrollBar) Qn(w, {top: -t + "px"}), S.test.top = -t + "px"; else {
                            var n = Fe(t);
                    ...
                    function $t() {
                        var e = g.licenseKey, t = "font-size: 15px;background:yellow;";
                        n ? e && e.length < 20 && (console.log("%c", t), console.log("%c", t)) : (console.log("%c", t), console.log("%c", t)), Gn(s, dn) ? Vn("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (g.continuousVertical && (g.loopTop || g.loopBottom) && (g.continuousVertical = !1, Vn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !g.scrollOverflow || !g.scrollBar && g.autoScrolling || Vn("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !g.continuousVertical || !g.scrollBar && g.autoScrolling || (g.continuousVertical = !1, Vn("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), g.scrollOverflow && null == g.scrollOverflowHandler && (g.scrollOverflow = !1, Vn("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), g.anchors.forEach(function (t) {
...
// add metadata on freeze-family methods calling
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1__);
            /* harmony import */
            var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(73);
            /* harmony import */
            ...
            /* harmony import */
            var core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31);
            /* harmony import */
            ...
            /* harmony import */
            var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(68);
            /* harmony import */
            var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_4__);
            /* harmony import */
            var core_js_modules_es7_array_includes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(66);
            /* harmony import */
            var core_js_modules_es7_array_includes__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_array_includes__WEBPACK_IMPORTED_MODULE_5__);
            /* harmony import */
            var core_js_modules_es6_string_includes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(65);
            /* harmony import */
            var core_js_modules_es6_string_includes__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_string_includes__WEBPACK_IMPORTED_MODULE_6__);
            /* harmony import */
            var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(61);
            /* harmony import */
            var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_7__);
            /* harmony import */
            var react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2);
            /* harmony import */
            var react__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_8__);
            /* harmony import */
            var fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(57);
            /* harmony import */
            var fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_9__);
            /* harmony import */
            var _Logger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(20);
            /* harmony import */
            var _selectors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6);
            ...
            var isEqualArray = function isEqualArray(firstArr, secondArr) {
                if (firstArr.length !== secondArr.length) return false;
                return firstArr.find(function (el) {
                    return !secondArr.includes(el);
                }) == null;
            };
            var fullpageCallbacks = ['afterLoad', 'afterRender', 'afterResize', 'afterResponsive', 'afterSlideLoad', 'onLeave', 'onSlideLeave'];
            var ReactFullpage =/*#__PURE__*/function (_React$Component) {
                _inherits(ReactFullpage, _React$Component);

                function ReactFullpage(props) {
                    var _this;
                    _classCallCheck(this, ReactFullpage);
                    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactFullpage).call(this, props));
                    var _this$props = _this.props, render = _this$props.render,
                        pluginWrapper = _this$props.pluginWrapper;
                    if (!isFunc(render)) {
                        throw new Error('must provide render prop to <ReactFullpage />');
                    }
                    _this.log = Object(_Logger__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_this.props.debug, 'ReactFullpage');
                    _this.log('Building component');
                    _this.log('Importing vendor files');
                    _this.importVendors();
                    if (pluginWrapper) {
                        _this.log('Calling plugin wrapper');
                        pluginWrapper();
                    }
                    _this.log('Requiring fullpage.js');
                    Fullpage = __webpack_require__(52);
                    _this.state = {initialized: false, sectionCount: 0, slideCount: 0};
                    return _this;
                }

                _createClass(ReactFullpage, [{
                    ...
                    key: "componentDidUpdate", value: function componentDidUpdate(prevProps) {
                        ...
                        var newSectionCount = this.getSectionCount();
                        var newSlideCount = this.getSlideCount();
                        var _this$state = this.state, sectionCount = _this$state.sectionCount,
                            slideCount = _this$state.slideCount;// comparing sectionColors array option
                    ...
                    key: "getSectionCount", value: function getSectionCount() {
                        var _this$props$sectionSe = this.props.sectionSelector,
                            sectionSelector = _this$props$sectionSe === void 0 ? _selectors__WEBPACK_IMPORTED_MODULE_11__[/* DEFAULT_SECTION */ "a"] : _this$props$sectionSe;
                        var _document$querySelect = document.querySelectorAll(sectionSelector),
                            length = _document$querySelect.length;
                        return length;
                    }
                }, {
                    key: "getSlideCount", value: function getSlideCount() {
                        var _this$props$slideSele = this.props.slideSelector,
                            slideSelector = _this$props$slideSele === void 0 ? _selectors__WEBPACK_IMPORTED_MODULE_11__[/* DEFAULT_SLIDE */ "b"] : _this$props$slideSele;
                        var _document$querySelect2 = document.querySelectorAll(slideSelector),
                            length = _document$querySelect2.length;
                        return length;
                    }
                }, {
                    key: "importVendors", value: function importVendors() {
                        var _this$props2 = this.props, scrollOverflow = _this$props2.scrollOverflow,
                    ...
                    key: "init", value: function init(opts) {
                        this.log('Reinitializing fullpage with options', opts);
                        new Fullpage(_selectors__WEBPACK_IMPORTED_MODULE_11__[/* ID_SELECTOR */ "c"], opts);// eslint-disable-line
                    ...
                    key: "markInitialized", value: function markInitialized() {
                    ...
                    key: "buildOptions", value: function buildOptions() {
                        var _this2 = this;
                        var filterCb = function filterCb(key) {
                            return !!Object.keys(_this2.props).find(function (cb) {
                                return cb === key;
                            });
                        };
                        var registered = fullpageCallbacks.filter(filterCb);
                        var listeners = registered.reduce(function (result, key) {
                            return _objectSpread({}, result, _defineProperty({}, key, function () {
                                for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
                                    args[_key] = arguments[_key];
                                }
                                return _this2.update.apply(_this2, [key].concat(args));
                            }));
                        }, {});// NOTE: override passed in callbacks w/  wrapped listeners
                        var options = _objectSpread({}, this.props, listeners);
                        this.log('Building fullpage.js options: ', options);
                        return options;
                    }
                }, {
                    key: "update", value: function update(lastEvent) {
                        var _this$props3;
                        ...
                        var makeState = function makeState(callbackParameters) {
                            return _objectSpread({}, state, callbackParameters, {lastEvent: lastEvent});
                        };
                        var fromArgs = function fromArgs(argList) {
                            return argList.reduce(function (result, key, i) {
                                var value = args[i];
...
// https://github.com/alvarotrigo/fullPage.js#callbacks
                        ...
                        var returned = (_this$props3 = this.props)[lastEvent].apply(_this$props3, args);
                    ...
                    key: "render", value: function render() {
                        this.log('<== Rendering ==>');
                        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {id: _selectors__WEBPACK_IMPORTED_MODULE_11__[/* MAIN_SELECTOR */ "d"]}, this.props.render(this));
                    }
                }]);
                return ReactFullpage;
            }(react__WEBPACK_IMPORTED_MODULE_8___default.a.Component);
            ReactFullpage.defaultProps = {sectionsColor: []};/* harmony default export */
            __webpack_exports__["default"] = (ReactFullpage);
