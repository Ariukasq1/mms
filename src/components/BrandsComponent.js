...
class BrandsComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="justify-start items-start brands px-40 2xl:px-20 xl:px-24 xl:pt-12 sm:px-5 lg:px-10 md:p-10 sm:h-auto md:h-auto lg:h-auto md:overflow-hidden sm:overflow-hidden lg:pt-28 lg:pb-20 md:pt-28 sm:pt-0 sm:pb-10">
        <div className="text-center sm:text-left">
          <div className="heading-tag capitalize text-xl font-bold sm:text-lg ">
            {__("Brands")}
          </div>
          <div className="heading-title mb-20 capitalize text-5xl xl:text-4xl sm:text-xl sm:leading-7 sm:my-4 sm:font-semibold">
            {__("Our products")}
          </div>
          {categories}
        </div>
