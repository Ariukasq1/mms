...
class ItemRelations extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="px-40 item-relations 2xl:px-20 pt-32 2xl:pt-28 xl:pl-40 xl:pr-0 lg:px-16 md:px-10 sm:pt-2 sm:px-8 sm:h-auto md:h-auto lg:py-10">
        <h2 className="text-menuTextColor font-bold text-2xl capitalize mb-3 xl:mb-6 sm:mb-2 2xl:mb-0">
          {__("Relations")}
        </h2>
