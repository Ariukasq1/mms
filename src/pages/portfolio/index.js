    ...
    return (
      ...
      >
        ...
        <div className={"interiorTexts flex flex-col justify-center"}>
          ...
          <div className={"mr-6 leading-6 sm:mr-2"}>{item.description}</div>
        </div>
      </div>
    );
  };
            ...
            <div id="fullpage">
              <div className="section">
                <div className="capabilitiesPage">
                  ...
                  <div
                    className="capabilitiesPageSlider px-72 xl:px-20 2xl:px-40 md:px-20 lg:px-20 sm:px-10"
                    style={{ flexBasis: "50%" }}
                  >
                    <SliderSubCategories
                      data={categories}
              ...
              <ItemDetailsWithGallery subcategory={categories} />
              ...
              <div className="section portfolio">
                <Portfolio background_image={background_image}>
                  ...
                  >
                    <div
                      className={
                        "flex flex-col justify-center mr-12 md:mr-2 md:ml-2 sm:mr-0"
                      }
                    >
...
Index.getInitialProps = async (ctx) => {
  ...
  const category = await fetcher(
    `${Config.apiUrl}/wp/v2/navigation_menus?slug=portfolio&${
      query === "mn" ? "?lang=" + query : ""
    }`
  );
