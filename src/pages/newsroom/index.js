        ...
        children={
          <div id="fullpage">
            <div className="section news">
              <div className="px-56 2xl:px-40 2xl:pt-20 pt-16 xl:px-24 xl:pt-20 lg:px-20 lg:pt-28 md:px-10 sm:px-5 sm:h-auto md:h-auto lg:h-auto md:overflow-hidden sm:overflow-hidden md:pt-29">
